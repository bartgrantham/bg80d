...
static opcode_spec_t z80_NP[] = {
    ...
    /*01*/  {"", 1, 2, 3, "LD", "BC", "nn", "LD BC, nn", "BC=nn", "Load BC (16bit) with 0x%.4X"},
    ...
    /*06*/  {"", 6, 1, 1, "LD", "B", "n", "LD B, n", "B=n", "Load register B with 0x%.2X"},
    ...
    /*0E*/  {"", 14, 1, 1, "LD", "C", "n", "LD C, n", "C=n", "Load register C with 0x%.2X"},
    ...
    /*11*/  {"", 17, 2, 3, "LD", "DE", "nn", "LD DE, nn", "DE=nn", "Load DE (16bit) with 0x%.4X"},
    ...
    /*16*/  {"", 22, 1, 1, "LD", "D", "n", "LD D, n", "D=n", "Load register D with 0x%.2X"},
    ...
    /*1E*/  {"", 30, 1, 1, "LD", "E", "n", "LD E, n", "E=n", "Load register E with 0x%.2X"},
    /*1F*/  {"", 31, 0, 0, "RR", "", "", "RRA", "c=>(A>>1)=>c", "Rotate right register A"},
    /*20*/  {"", 32, 1, 2, "JR", "", "d", "JRNZ d", "PC+=(z=0)?d:0", "Jump %+d%s if z flag is 0"},
    /*21*/  {"", 33, 2, 3, "LD", "HL", "nn", "LD HL, nn", "HL=nn", "Load HL (16bit) with 0x%.4X"},
    /*22*/  {"", 34, 2, 3, "LD", "$nn", "HL", "LD (nn), HL", "$nn=HL", "Load memory $%.4X (16bit) with register HL"},
    /*23*/  {"", 35, 0, 0, "INC", "HL", "", "INC HL", "HL++", "Increment HL (16bit)"},
    /*24*/  {"", 36, 0, 0, "INC", "H", "", "INC H", "H++", "Increment H"},
    /*25*/  {"", 37, 0, 0, "DEC", "H", "", "DEC H", "H--", "Decrement H"},
    /*26*/  {"", 38, 1, 1, "LD", "H", "n", "LD H, n", "H=n", "Load register H with 0x%.2X"},
    ...
    /*2A*/  {"", 42, 2, 3, "LD", "HL", "$nn", "LD HL, (nn)", "HL=$nn", "Load HL (16bit) with memory $%.4X"},
    /*2B*/  {"", 43, 0, 0, "DEC", "HL", "", "DEC HL", "HL--", "Decrement HL (16bit)"},
    /*2C*/  {"", 44, 0, 0, "INC", "L", "", "INC L", "L++", "Increment L"},
    /*2D*/  {"", 45, 0, 0, "DEC", "L", "", "DEC L", "L--", "Decrement L"},
    /*2E*/  {"", 46, 1, 1, "LD", "L", "n", "LD L, n", "L=n", "Load register L with 0x%.2X"},
    /*2F*/  {"", 47, 0, 0, "CPL", "", "", "CPL", "A=~A", "Invert register A"},
    /*30*/  {"", 48, 1, 2, "JR", "", "d", "JRNC d", "PC+=(c=0)?d:0", "Jump %+d%s if c flag is 0"},
    /*31*/  {"", 49, 2, 3, "LD", "SP", "nn", "LD SP, nn", "SP=nn", "Load SP (16bit) with 0x%.4X"},
    /*32*/  {"", 50, 2, 3, "LD", "$nn", "A", "LD (nn), A", "$nn=A", "Load memory $%.4X with register A"},
    ...
    /*36*/  {"", 54, 1, 1, "LD", "$HL", "n", "LD (HL), n", "$HL=n", "Load memory $HL with 0x%.2X"},
    ...
    /*3A*/  {"", 58, 2, 3, "LD", "A", "$nn", "LD A, (nn)", "A=$nn", "Load register A with memory $%.4X"},
    /*3B*/  {"", 59, 0, 0, "DEC", "SP", "", "DEC SP", "SP--", "Decrement SP (16bit)"},
    /*3C*/  {"", 60, 0, 0, "INC", "A", "", "INC A", "A++", "Increment A"},
    /*3D*/  {"", 61, 0, 0, "DEC", "A", "", "DEC A", "A--", "Decrement A"},
    /*3E*/  {"", 62, 1, 1, "LD", "A", "n", "LD A, n", "A=n", "Load register A with 0x%.2X"},
    ...
    /*C2*/  {"", 194, 2, 3, "JP", "", "nn", "JPNZ nn", "if(z=0) JUMP $nn", "Jump to $%.4X if Z flag is 0"},
    /*C3*/  {"", 195, 2, 3, "JP", "", "nn", "JP nn", "JUMP $nn", "Jump to $%.4X"},
    /*C4*/  {"", 196, 2, 3, "CALL", "", "", "CALLNZ, nn", "if(z=0) CALL $nn", "Call $%.4X if Z flag is 0"},
    /*C5*/  {"", 197, 0, 0, "PUSH", "(SP)", "BC", "PUSH BC", "$SP=BC,SP-=2", "Load top of stack (16bit) with BC"},
    /*C6*/  {"", 198, 1, 1, "ADD", "A", "n", "ADD A, n", "A+=n", "Add 0x%.2X to register A"},
    ...
    /*CA*/  {"", 202, 2, 3, "JP", "", "nn", "JPZ nn", "if(z=1) JUMP $nn", "Jump to $%.4X if Z flag is 1"},
    /*CB*/  {"", 203, 0, 0, "[CB]", "", "", "[CB]", "--", "CB instruction prefix"},
    /*CC*/  {"", 204, 2, 3, "CALL", "", "nn", "CALLZ nn", "if(z=1) CALL $nn", "Call $%.4X if Z flag is 1"},
    /*CD*/  {"", 205, 2, 3, "CALL", "", "nn", "CALL nn", "CALL $nn", "Call $%.4X"},
    /*CE*/  {"", 206, 1, 1, "ADC", "A", "n", "ADC A, n", "(c,A)+=n", "Add with Carry 0x%.2X to register A"},
    ...
    /*D2*/  {"", 210, 2, 3, "JP", "", "nn", "JPNC nn", "if(c=0) JUMP $nn", "Jump to $%.4X if C flag is 0"},
    /*D3*/  {"", 211, 1, 1, "OUT", "(n)", "A", "OUT n", "OUT(n)=A", "Load port 0x%.2X with register A"},
    /*D4*/  {"", 212, 2, 3, "CALL", "", "nn", "CALLNC nn", "if(c=0) CALL $nn", "Call $%.4X if C flag is 0"},
    /*D5*/  {"", 213, 0, 0, "PUSH", "(SP)", "DE", "PUSH DE", "$SP=DE,SP-=2", "Load top of stack (16bit) with DE"},
    /*D6*/  {"", 214, 1, 1, "SUB", "A", "n", "SUB A, n", "A-=n", "Subtract 0x%.2X from register A"},
    ...
    /*DA*/  {"", 218, 2, 3, "JP", "", "nn", "JPC nn", "if(c=1) JUMP $nn", "Jump to $%.4X if C flag is 1"},
    /*DB*/  {"", 219, 1, 1, "IN", "A", "(n)", "IN n", "A=IN(n)", "Load register A with port 0x%.2X"},
    /*DC*/  {"", 220, 2, 3, "CALL", "", "nn", "CALLC nn", "if(c=1) CALL $nn", "Call $%.4X if C flag is 1"},
    /*DD*/  {"", 221, 0, 0, "[IX]", "", "", "[IX]", "--", "DD instruction prefix (IX indexing)"},
    /*DE*/  {"", 222, 1, 1, "SBC", "A", "n", "SBC A, n", "(c,A)-=n", "Subtract with Carry 0x%.2X from register A"},
    ...
    /*E2*/  {"", 226, 2, 3, "JP", "", "nn", "JPPO nn", "if(p=0) JUMP $nn", "Jump to $%.4X if P flag is 0 (odd parity)"},
    /*E3*/  {"", 227, 0, 0, "EX", "(SP)", "HL", "EX (SP), HL", "HL<=>$SP", "Exchange HL with $SP"},
    /*E4*/  {"", 228, 2, 3, "CALL", "", "nn", "CALLPO nn", "if(p=0) CALL $nn", "Call $%.4X if P flag is 0 (odd parity)"},
    /*E5*/  {"", 229, 0, 0, "PUSH", "", "HL", "PUSH HL", "$SP=HL,SP-=2", "Load top of stack (16bit) with HL"},
    /*E6*/  {"", 230, 1, 1, "AND", "A", "n", "AND A, n", "A&=n", "AND of 0x%.2X to register A"},
    ...
    /*EA*/  {"", 234, 2, 3, "JP", "", "nn", "JPPE nn", "if(p=1) JUMP $nn", "Jump to $%.4X if P flag is 1 (even parity)"},
    /*EB*/  {"", 235, 0, 0, "EX", "DE", "HL", "EX DE, HL", "DE<=>HL", "Exchange DE with HL"},
    /*EC*/  {"", 236, 2, 3, "CALL", "", "nn", "CALLPE nn", "if(p=1) CALL $nn", "Call $%.4X if P flag is 1 (even parity)"},
    /*ED*/  {"", 237, 0, 0, "[ED]", "", "", "[ED]", "--", "ED instruction prefix"},
    /*EE*/  {"", 238, 1, 1, "XOR", "A", "n", "XOR A, n", "A^=n", "XOR of 0x%.2X to register A"},
    ...
    /*F2*/  {"", 242, 2, 3, "JP", "", "nn", "JPP nn", "if(s=0) JUMP $nn", "Jump to $%.4X if S flag is 0 (positive)"},
    /*F3*/  {"", 243, 0, 0, "DI", "", "", "DI", "I=0", "Disable interrupts"},
    /*F4*/  {"", 244, 2, 3, "CALL", "", "nn", "CALLP nn", "if(s=0) CALL $nn", "Call $%.4X if S flag is 0 (positive)"},
    /*F5*/  {"", 245, 0, 0, "PUSH", "(SP)", "AF", "PUSH AF", "$SP=AF,SP-=2", "Load top of stack (16bit) with AF"},
    /*F6*/  {"", 246, 1, 1, "OR", "A", "n", "OR A, n", "A|=n", "OR of 0x%.2X to register A"},
    ...
    /*FA*/  {"", 250, 2, 3, "JP", "", "nn", "JPM nn", "if(s=1) JUMP $nn", "Jump to $%.4X if S flag is 1 (negative)"},
    /*FB*/  {"", 251, 0, 0, "EI", "", "", "EI", "I=1", "Enable Interrupts"},
    /*FC*/  {"", 252, 2, 3, "CALL", "", "nn", "CALLM nn", "if(s=1) CALL $nn", "Call $%.4X if S flag is 1 (negative)"},
    /*FD*/  {"", 253, 0, 0, "[IY]", "", "", "[IY]", "--", "FD instruction prefix (IY indexing)"},
    /*FE*/  {"", 254, 1, 1, "CP", "", "n", "CP A, n", "(c,h,p,z)=(A-n)", "Compare 0x%.2X and register A"},
...
static opcode_spec_t z80_DD[] = {
    ...
    /*DD01*/  {"DD", 1, 2, 3, "LD", "BC", "nn", "LD BC, nn", "BC=nn", "Load BC (16bit) with 0x%.4X (undocumented)"},
    ...
    /*DD06*/  {"DD", 6, 1, 1, "LD", "B", "n", "LD B, n", "B=n", "Load register B with 0x%.2X (undocumented)"},
    ...
    /*DD0E*/  {"DD", 14, 1, 1, "LD", "C", "n", "LD C, n", "C=n", "Load register C with 0x%.2X (undocumented)"},
    ...
    /*DD11*/  {"DD", 17, 2, 3, "LD", "DE", "nn", "LD DE, nn", "DE=nn", "Load DE (16bit) with 0x%.4X (undocumented)"},
    ...
    /*DD16*/  {"DD", 22, 1, 1, "LD", "D", "n", "LD D, n", "D=n", "Load register D with 0x%.2X (undocumented)"},
    ...
    /*DD1E*/  {"DD", 30, 1, 1, "LD", "E", "n", "LD E, n", "E=n", "Load register E with 0x%.2X (undocumented)"},
    ...
    /*DD21*/  {"DD", 33, 2, 3, "LD", "IX", "nn", "LD IX, nn", "IX=nn", "Load (16bit) IX with 0x%.4X"},
    /*DD22*/  {"DD", 34, 2, 3, "LD", "(nn)", "IX", "LD (nn), IX", "$nn=IX", "Load memory $%.4X (16bit) with register IX"},
    ...
    /*DD26*/  {"DD", 38, 1, 1, "LD", "IXh", "n", "LD IXh, n", "IXh=n", "Load the high byte of IX with 0x%.2X (undocumented)"},
    ...
    /*DD2A*/  {"DD", 42, 2, 3, "LD", "IX", "(nn)", "LD IX,(nn)", "IX=$nn", "Load register IX (16bit) with memory $%.4X"},
    ...
    /*DD2E*/  {"DD", 46, 1, 1, "LD", "IXl", "n", "LD IXl, n", "IXl=n", "Load the low byte of IX with 0x%.2X (undocumented)"},
    ...
    /*DD31*/  {"DD", 49, 2, 3, "LD", "SP", "nn", "LD SP, nn", "SP=nn", "Load SP (16bit) with 0x%.4X (undocumented)"},
    /*DD32*/  {"DD", 50, 2, 3, "LD", "$nn", "A", "LD (nn), A", "$nn=A", "Load memory $%.4X with register A (undocumented)"},
    ...
    /*DD36*/  {"DD", 54, 2, 4, "LD", "(IX+d)", "n", "LD (IX+d), n", "$(IX+d)=n", "Load memory $(IX%+d) with 0x%.2X"},
    ...
    /*DD3A*/  {"DD", 58, 2, 3, "LD", "A", "$nn", "LD A, (nn)", "A=$nn", "Load register A with memory $%.4X (undocumented)"},
    ...
    /*DD3E*/  {"DD", 62, 1, 1, "LD", "A", "n", "LD A, n", "A=n", "Load register A with 0x%.2X (undocumented)"},
    ...
    /*DDC2*/  {"DD", 194, 2, 3, "JP", "", "nn", "JPNZ nn", "if(z=0) JUMP $nn", "Jump to $%.4X if Z flag is 0 (undocumented)"},
    /*DDC3*/  {"DD", 195, 2, 3, "JP", "", "nn", "JP nn", "JUMP $nn", "Jump to $%.4X (undocumented)"},
    /*DDC4*/  {"DD", 196, 2, 3, "CALL", "", "", "CALLNZ, nn", "if(z=0) CALL $nn", "Call $%.4X if Z flag is 0 (undocumented)"},
    /*DDC5*/  {"DD", 197, 0, 0, "PUSH", "(SP)", "BC", "PUSH BC", "$SP=BC,SP-=2", "Load top of stack (16bit) with BC (undocumented)"},
    /*DDC6*/  {"DD", 198, 1, 1, "ADD", "A", "n", "ADD A, n", "A+=n", "Add 0x%.2X to register A (undocumented)"},
    ...
    /*DDCA*/  {"DD", 202, 2, 3, "JP", "", "nn", "JPZ nn", "if(z=1) JUMP $nn", "Jump to $%.4X if Z flag is 1 (undocumented)"},
    /*DDCB*/  {"DD", 203, 0, 0, "[IX]", "", "", "[IX]", "--", "DDCB instruction prefix (IX loads and bit manipulation)"},
    /*DDCC*/  {"DD", 204, 2, 3, "CALL", "", "nn", "CALLZ nn", "if(z=1) CALL $nn", "Call $%.4X if Z flag is 1 (undocumented)"},
    /*DDCD*/  {"DD", 205, 2, 3, "CALL", "", "nn", "CALL nn", "CALL $nn", "Call $%.4X (undocumented)"},
    /*DDCE*/  {"DD", 206, 1, 1, "ADC", "A", "n", "ADC A, n", "(c,A)+=n", "Add with Carry 0x%.2X to register A (undocumented)"},
    ...
    /*DDD2*/  {"DD", 210, 2, 3, "JP", "", "nn", "JPNC nn", "if(c=0) JUMP $nn", "Jump to $%.4X if C flag is 0 (undocumented)"},
    /*DDD3*/  {"DD", 211, 1, 1, "OUT", "(n)", "A", "OUT n", "OUT(n)=A", "Load port 0x%.2X with register A (undocumented)"},
    /*DDD4*/  {"DD", 212, 2, 3, "CALL", "", "nn", "CALLNC nn", "if(c=0) CALL $nn", "Call $%.4X if C flag is 0 (undocumented)"},
    /*DDD5*/  {"DD", 213, 0, 0, "PUSH", "(SP)", "DE", "PUSH DE", "$SP=DE,SP-=2", "Load top of stack (16bit) with DE (undocumented)"},
    /*DDD6*/  {"DD", 214, 1, 1, "SUB", "A", "n", "SUB A, n", "A-=n", "Subtract 0x%.2X from register A (undocumented)"},
    ...
    /*DDDA*/  {"DD", 218, 2, 3, "JP", "", "nn", "JPC", "if(c=1) JUMP $nn", "Jump to $%.4X if C flag is 1 (undocumented)"},
    /*DDDB*/  {"DD", 219, 1, 1, "IN", "A", "(n)", "IN n", "A=IN(n)", "Load register A with port 0x%.2X (undocumented)"},
    /*DDDC*/  {"DD", 220, 2, 3, "CALL", "", "nn", "CALLC nn", "if(c=1) CALL $nn", "Call $%.4X if C flag is 1 (undocumented)"},
    /*DDDD*/  {"DD", 221, 0, 0, "[IX]", "", "", "[IX]", "--", "DD instruction prefix (IX indexing) (undocumented)"},
    /*DDDE*/  {"DD", 222, 1, 1, "SBC", "A", "n", "SBC A, n", "(c,A)-=n", "Subtract with Carry 0x%.2X from register A (undocumented)"},
    ...
    /*DDE2*/  {"DD", 226, 2, 3, "JP", "", "nn", "JPPO nn", "if(p=0) JUMP $nn", "Jump to $%.4X if P flag is 0 (odd parity) (undocumented)"},
    /*DDE3*/  {"DD", 227, 0, 0, "EX", "(SP)", "IX", "EX (SP),IX", "$SP<=>HL", "Exchange the top of stack with register HL"},
    /*DDE4*/  {"DD", 228, 2, 3, "CALL", "", "nn", "CALLPO nn", "if(p=0) CALL $nn", "Call $%.4X if P flag is 0 (odd parity) (undocumented)"},
    /*DDE5*/  {"DD", 229, 0, 0, "PUSH", "(SP)", "IX", "PUSH IX", "$SP=IX,SP-=2", "Load top of stack (16bit) with register IX"},
    /*DDE6*/  {"DD", 230, 1, 1, "AND", "A", "n", "AND A, n", "A&=n", "AND of 0x%.2X to register A (undocumented)"},
    ...
    /*DDEA*/  {"DD", 234, 2, 3, "JP", "", "nn", "JPPE nn", "if(p=1) JUMP $nn", "Jump to $%.4X if P flag is 1 (even parity) (undocumented)"},
    /*DDEB*/  {"DD", 235, 0, 0, "EX", "DE", "HL", "EX DE, HL", "DE<=>HL", "Exchange DE with HL (undocumented)"},
    /*DDEC*/  {"DD", 236, 2, 3, "CALL", "", "nn", "CALLPE nn", "if(p=1) CALL $nn", "Call $%.4X if P flag is 1 (even parity) (undocumented)"},
    /*DDED*/  {"DD", 237, 0, 0, "[ED]", "", "", "[ED]", "--", "ED instruction prefix (undocumented)"},
    /*DDEE*/  {"DD", 238, 1, 1, "XOR", "A", "n", "XOR A, n", "A^=n", "XOR of 0x%.2X to register A (undocumented)"},
    ...
    /*DDF2*/  {"DD", 242, 2, 3, "JP", "", "nn", "JPP nn", "if(s=0) JUMP $nn", "Jump to $%.4X if S flag is 0 (positive) (undocumented)"},
    /*DDF3*/  {"DD", 243, 0, 0, "DI", "", "", "DI", "I=0", "Disable interrupts (undocumented)"},
    /*DDF4*/  {"DD", 244, 2, 3, "CALL", "", "nn", "CALLP nn", "if(s=0) CALL $nn", "Call $%.4X if S flag is 0 (positive) (undocumented)"},
    /*DDF5*/  {"DD", 245, 0, 0, "PUSH", "(SP)", "AF", "PUSH AF", "$SP=AF,SP-=2", "Load top of stack (16bit) with AF (undocumented)"},
    /*DDF6*/  {"DD", 246, 1, 1, "OR", "A", "n", "OR A, n", "A|=n", "OR of 0x%.2X to register A (undocumented)"},
    ...
    /*DDFA*/  {"DD", 250, 2, 3, "JP", "", "nn", "JPM nn", "if(s=1) JUMP $nn", "Jump to $%.4X if S flag is 1 (negative) (undocumented)"},
    /*DDFB*/  {"DD", 251, 0, 0, "EI", "", "", "EI", "I=1", "Enable Interrupts (undocumented)"},
    /*DDFC*/  {"DD", 252, 2, 3, "CALL", "", "nn", "CALLM nn", "if(s=1) CALL $nn", "Call $%.4X if S flag is 1 (negative) (undocumented)"},
    /*DDFD*/  {"DD", 253, 0, 0, "[IY]", "", "", "[IY]", "--", "FD instruction prefix (IY indexing) (undocumented)"},
    /*DDFE*/  {"DD", 254, 1, 1, "CP", "", "n", "CP A, n", "(c,h,p,z)=(A-n)", "Compare 0x%.2X and register A (undocumented)"},
...
static opcode_spec_t z80_ED[] = {
    ...
    /*ED43*/  {"ED", 67, 2, 3, "LD", "(nn)", "BC", "LD (nn), BC", "$nn=BC", "Load (16bit) memory $%.4X with register BC"},
    ...
    /*ED4B*/  {"ED", 75, 2, 3, "LD", "BC", "$nn", "LD BC, (nn)", "BC=$nn", "Load (16bit) register BC with memory $%.4X"},
    ...
    /*ED53*/  {"ED", 83, 2, 3, "LD", "(nn)", "DE", "LD (nn), DE", "$nn=DE", "Load (16bit) memory $%.4X with register DE"},
    ...
    /*ED5B*/  {"ED", 91, 2, 3, "LD", "DE", "$nn", "LD DE, (nn)", "DE=$nn", "Load (16bit) register DE with memory $%.4X"},
    ...
    /*ED63*/  {"ED", 99, 2, 3, "LD", "(nn)", "HL", "LD (nn), HL", "$nn=HL", "Load (16bit) memory $%.4X with register HL"},
    ...
    /*ED6B*/  {"ED", 107, 2, 3, "LD", "HL", "$nn", "LD HL, (nn)", "HL=$nn", "Load (16bit) register HL with memory $%.4X"},
    ...
    /*ED73*/  {"ED", 115, 2, 3, "LD", "(nn)", "SP", "LD (nn), SP", "$nn=SP", "Load (16bit) memory $%.4X with register SP"},
    ...
    /*ED7B*/  {"ED", 123, 2, 3, "LD", "SP", "(nn)", "LD SP, (nn)", "SP=$nn", "Load (16bit) register SP with memory $%.4X"},
...
static opcode_spec_t z80_FD[] = {
    ...
    /*FD01*/  {"FD", 1, 2, 3, "LD", "BC", "nn", "LD BC, nn", "BC=nn", "Load BC (16bit) with 0x%.4X (undocumented)"},
    ...
    /*FD06*/  {"FD", 6, 1, 1, "LD", "B", "n", "LD B, n", "B=n", "Load register B with 0x%.2X (undocumented)"},
    ...
    /*FD0E*/  {"FD", 14, 1, 1, "LD", "C", "n", "LD C, n", "C=n", "Load register C with 0x%.2X (undocumented)"},
    ...
    /*FD11*/  {"FD", 17, 2, 3, "LD", "DE", "nn", "LD DE, nn", "DE=nn", "Load DE (16bit) with 0x%.4X (undocumented)"},
    ...
    /*FD16*/  {"FD", 22, 1, 1, "LD", "D", "n", "LD D, n", "D=n", "Load register D with 0x%.2X (undocumented)"},
    ...
    /*FD1E*/  {"FD", 30, 1, 1, "LD", "E", "n", "LD E, n", "E=n", "Load register E with 0x%.2X (undocumented)"},
    ...
    /*FD21*/  {"FD", 33, 2, 3, "LD", "IY", "nn", "LD IY, nn", "IY=nn", "Load (16bit) IY with 0x%.4X"},
    /*FD22*/  {"FD", 34, 2, 3, "LD", "(nn)", "IY", "LD (nn), IY", "$nn=IY", "Load memory $%.4X (16bit) with register IY"},
    ...
    /*FD26*/  {"FD", 38, 1, 1, "LD", "IYh", "n", "LD IYh, n", "IYh=n", "Load the high byte of IY with 0x%.2X (undocumented)"},
    ...
    /*FD2A*/  {"FD", 42, 2, 3, "LD", "IY", "(nn)", "LD IY,(nn)", "IY=$nn", "Load register IY (16bit) with memory $%.4X"},
    ...
    /*FD2E*/  {"FD", 46, 1, 1, "LD", "IYl", "n", "LD IYl, n", "IYl=n", "Load the low byte of IY with 0x%.2X (undocumented)"},
    ...
    /*FD31*/  {"FD", 49, 2, 3, "LD", "SP", "nn", "LD SP, nn", "SP=nn", "Load SP (16bit) with 0x%.4X (undocumented)"},
    /*FD32*/  {"FD", 50, 2, 3, "LD", "$nn", "A", "LD (nn), A", "$nn=A", "Load memory $%.4X with register A (undocumented)"},
    ...
    /*FD36*/  {"FD", 54, 2, 4, "LD", "(IY+d)", "n", "LD (IY+d), n", "$(IY+d)=n", "Load memory $(IY%+d) with 0x%.2X"},
    ...
    /*FD3A*/  {"FD", 58, 2, 3, "LD", "A", "$nn", "LD A, (nn)", "A=$nn", "Load register A with memory $%.4X (undocumented)"},
    ...
    /*FD3E*/  {"FD", 62, 1, 1, "LD", "A", "n", "LD A, n", "A=n", "Load register A with 0x%.2X (undocumented)"},
    ...
    /*FDC2*/  {"FD", 194, 2, 3, "JP", "", "nn", "JPNZ nn", "if(z=0) JUMP $nn", "Jump to $%.4X if Z flag is 0 (undocumented)"},
    /*FDC3*/  {"FD", 195, 2, 3, "JP", "", "nn", "JP nn", "JUMP $nn", "Jump to $%.4X (undocumented)"},
    /*FDC4*/  {"FD", 196, 2, 3, "CALL", "", "", "CALLNZ, nn", "if(z=0) CALL $nn", "Call $%.4X if Z flag is 0 (undocumented)"},
    /*FDC5*/  {"FD", 197, 0, 0, "PUSH", "(SP)", "BC", "PUSH BC", "$SP=BC,SP-=2", "Load top of stack (16bit) with BC (undocumented)"},
    /*FDC6*/  {"FD", 198, 1, 1, "ADD", "A", "n", "ADD A, n", "A+=n", "Add 0x%.2X to register A (undocumented)"},
    ...
    /*FDCA*/  {"FD", 202, 2, 3, "JP", "", "nn", "JPZ nn", "if(z=1) JUMP $nn", "Jump to $%.4X if Z flag is 1 (undocumented)"},
    /*FDCB*/  {"FD", 203, 0, 0, "[IY]", "", "", "[IY]", "--", "DDCB instruction prefIY (IY loads and bit manipulation)"},
    /*FDCC*/  {"FD", 204, 2, 3, "CALL", "", "nn", "CALLZ nn", "if(z=1) CALL $nn", "Call $%.4X if Z flag is 1 (undocumented)"},
    /*FDCD*/  {"FD", 205, 2, 3, "CALL", "", "nn", "CALL nn", "CALL $nn", "Call $%.4X (undocumented)"},
    /*FDCE*/  {"FD", 206, 1, 1, "ADC", "A", "n", "ADC A, n", "(c,A)+=n", "Add with Carry 0x%.2X to register A (undocumented)"},
    ...
    /*FDD2*/  {"FD", 210, 2, 3, "JP", "", "nn", "JPNC nn", "if(c=0) JUMP $nn", "Jump to $%.4X if C flag is 0 (undocumented)"},
    /*FDD3*/  {"FD", 211, 1, 1, "OUT", "(n)", "A", "OUT n", "OUT(n)=A", "Load port 0x%.2X with register A (undocumented)"},
    /*FDD4*/  {"FD", 212, 2, 3, "CALL", "", "nn", "CALLNC nn", "if(c=0) CALL $nn", "Call $%.4X if C flag is 0 (undocumented)"},
    /*FDD5*/  {"FD", 213, 0, 0, "PUSH", "(SP)", "DE", "PUSH DE", "$SP=DE,SP-=2", "Load top of stack (16bit) with DE (undocumented)"},
    /*FDD6*/  {"FD", 214, 1, 1, "SUB", "A", "n", "SUB A, n", "A-=n", "Subtract 0x%.2X from register A (undocumented)"},
    ...
    /*FDDA*/  {"FD", 218, 2, 3, "JP", "", "nn", "JPC", "if(c=1) JUMP $nn", "Jump to $%.4X if C flag is 1 (undocumented)"},
    /*FDDB*/  {"FD", 219, 1, 1, "IN", "A", "(n)", "IN n", "A=IN(n)", "Load register A with port 0x%.2X (undocumented)"},
    /*FDDC*/  {"FD", 220, 2, 3, "CALL", "", "nn", "CALLC nn", "if(c=1) CALL $nn", "Call $%.4X if C flag is 1 (undocumented)"},
    /*FDDD*/  {"FD", 221, 0, 0, "[IX]", "", "", "[IX]", "--", "DD instruction prefix (IX indexing) (undocumented)"},
    /*FDDE*/  {"FD", 222, 1, 1, "SBC", "A", "n", "SBC A, n", "(c,A)-=n", "Subtract with Carry 0x%.2X from register A (undocumented)"},
    ...
    /*FDE2*/  {"FD", 226, 2, 3, "JP", "", "nn", "JPPO nn", "if(p=0) JUMP $nn", "Jump to $%.4X if P flag is 0 (odd parity) (undocumented)"},
    /*FDE3*/  {"FD", 227, 0, 0, "EX", "(SP)", "IY", "EX (SP),IY", "$SP<=>HL", "Exchange the top of stack with register HL"},
    /*FDE4*/  {"FD", 228, 2, 3, "CALL", "", "nn", "CALLPO nn", "if(p=0) CALL $nn", "Call $%.4X if P flag is 0 (odd parity) (undocumented)"},
    /*FDE5*/  {"FD", 229, 0, 0, "PUSH", "(SP)", "IY", "PUSH IY", "$SP=IY,SP-=2", "Load top of stack (16bit) with register IY"},
    /*FDE6*/  {"FD", 230, 1, 1, "AND", "A", "n", "AND A, n", "A&=n", "AND of 0x%.2X to register A (undocumented)"},
    ...
    /*FDEA*/  {"FD", 234, 2, 3, "JP", "", "nn", "JPPE nn", "if(p=1) JUMP $nn", "Jump to $%.4X if P flag is 1 (even parity) (undocumented)"},
    /*FDEB*/  {"FD", 235, 0, 0, "EX", "DE", "HL", "EX DE, HL", "DE<=>HL", "Exchange DE with HL (undocumented)"},
    /*FDEC*/  {"FD", 236, 2, 3, "CALL", "", "nn", "CALLPE nn", "if(p=1) CALL $nn", "Call $%.4X if P flag is 1 (even parity) (undocumented)"},
    /*FDED*/  {"FD", 237, 0, 0, "[ED]", "", "", "[ED]", "--", "ED instruction prefix (undocumented)"},
    /*FDEE*/  {"FD", 238, 1, 1, "XOR", "A", "n", "XOR A, n", "A^=n", "XOR of 0x%.2X to register A (undocumented)"},
    ...
    /*FDF2*/  {"FD", 242, 2, 3, "JP", "", "nn", "JPP nn", "if(s=0) JUMP $nn", "Jump to $%.4X if S flag is 0 (positive) (undocumented)"},
    /*FDF3*/  {"FD", 243, 0, 0, "DI", "", "", "DI", "I=0", "Disable interrupts (undocumented)"},
    /*FDF4*/  {"FD", 244, 2, 3, "CALL", "", "nn", "CALLP nn", "if(s=0) CALL $nn", "Call $%.4X if S flag is 0 (positive) (undocumented)"},
    /*FDF5*/  {"FD", 245, 0, 0, "PUSH", "(SP)", "AF", "PUSH AF", "$SP=AF,SP-=2", "Load top of stack (16bit) with AF (undocumented)"},
    /*FDF6*/  {"FD", 246, 1, 1, "OR", "A", "n", "OR A, n", "A|=n", "OR of 0x%.2X to register A (undocumented)"},
    ...
    /*FDFA*/  {"FD", 250, 2, 3, "JP", "", "nn", "JPM nn", "if(s=1) JUMP $nn", "Jump to $%.4X if S flag is 1 (negative) (undocumented)"},
    /*FDFB*/  {"FD", 251, 0, 0, "EI", "", "", "EI", "I=1", "Enable Interrupts (undocumented)"},
    /*FDFC*/  {"FD", 252, 2, 3, "CALL", "", "nn", "CALLM nn", "if(s=1) CALL $nn", "Call $%.4X if S flag is 1 (negative) (undocumented)"},
    /*FDFD*/  {"FD", 253, 0, 0, "[IY]", "", "", "[IY]", "--", "FD instruction prefix (IY indexing) (undocumented)"},
    /*FDFE*/  {"FD", 254, 1, 1, "CP", "", "n", "CP A, n", "(c,h,p,z)=(A-n)", "Compare 0x%.2X and register A (undocumented)"},
