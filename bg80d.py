...
--skip=skip.txt,...          A file that lists extents that should be skipped entirely.
...
--annotation=anno.txt,...    Use a file that consists of a memory spec on a line by itself followed by an annotation
